...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  data.genero == 'hombre'
    ? document.getElementById('checkgenero1').setAttribute('checked', 'true')
    : '';
  data.genero == 'mujer'
    ? document.getElementById('checkgenero2').setAttribute('checked', 'true')
    : '';
  data.genero == 'diverso'
    ? document.getElementById('checkgenero3').setAttribute('checked', 'true')
    : '';

  data.edocivil == 'soltero'
    ? document.getElementById('checkedocivil1').setAttribute('checked', 'true')
    : '';
  data.edocivil == 'casado'
    ? document.getElementById('checkedocivil2').setAttribute('checked', 'true')
    : '';
  data.edocivil == 'divorciado'
    ? document.getElementById('checkedocivil3').setAttribute('checked', 'true')
    : '';
  data.edocivil == 'otro'
    ? document.getElementById('checkedocivil4').setAttribute('checked', 'true')
    : '';
  ...
  data.tratadopormedico == 'true'
    ? document
        .getElementById('checktratadopormedico1')
        .setAttribute('checked', 'true')
    : '';
  data.tratadopormedico == 'false'
    ? document
        .getElementById('checktratadopormedico2')
        .setAttribute('checked', 'true')
    : '';

  document.getElementById('tratadoporenfermedad').value =
    data.tratadoporenfermedad;

  data.checktomamedicamento == 'true'
    ? document
        .getElementById('checktomamedicamento1')
        .setAttribute('checked', 'true')
    : '';
  data.checktomamedicamento == 'false'
    ? document
        .getElementById('checktomamedicamento2')
        .setAttribute('checked', 'true')
    : '';
  ...
  data.alergias.forEach(alergia => {
    ...
    alergia == 'aspirina'
      ? document.getElementById('checkaspirina').setAttribute('checked', 'true')
      : '';
    alergia == 'penicilina'
      ? document
          .getElementById('checkpenicilina')
          .setAttribute('checked', 'true')
      : '';
    alergia == 'Anestecia-Local'
      ? document
          .getElementById('checkanestecialocal')
          .setAttribute('checked', 'true')
      : '';
    alergia == 'codeina'
      ? document.getElementById('checkcodeina').setAttribute('checked', 'true')
      : '';
    alergia == 'Latex'
      ? document.getElementById('checklatex').setAttribute('checked', 'true')
      : '';
    alergia == 'Acrilico'
      ? document.getElementById('checkacrilico').setAttribute('checked', 'true')
      : '';
  });

  data.checkalergicootros == 'true'
    ? document
        .getElementById('checkalergicootros')
        .setAttribute('checked', 'true')
    : '';
  document.getElementById('textalergicootros').value = data.textalergicootros;

  data.checkcirugias == 'true'
    ? document
        .getElementById('checkalergicootros')
        .setAttribute('checked', 'true')
    : '';
  ...
  data.antecedentesPersonales.forEach(antecedente => {
    antecedente == 'Tuvo-Cirugias'
      ? document.getElementById('checkcirugias').setAttribute('checked', 'true')
      : '';
    antecedente == 'Tuvo-Lesiones-Cabeza'
      ? document.getElementById('checklesiones').setAttribute('checked', 'true')
      : '';
    antecedente == 'Tiene-Dieta'
      ? document.getElementById('checkdieta').setAttribute('checked', 'true')
      : '';
    antecedente == 'Es Fumador'
      ? document.getElementById('checkfumador').setAttribute('checked', 'true')
      : '';
    antecedente == 'Usa-Sustancias-Controladas'
      ? document
          .getElementById('checkcontroladas')
          .setAttribute('checked', 'true')
      : '';
    antecedente == 'Esta-Embarazada'
      ? document
          .getElementById('checkembarazada')
          .setAttribute('checked', 'true')
      : '';
    antecedente == 'Usa-Anticonceptivos'
      ? document
          .getElementById('checkanticonceptivos')
          .setAttribute('checked', 'true')
      : '';
    antecedente == 'Esta-Amamantando'
      ? document
          .getElementById('checkamamantando')
          .setAttribute('checked', 'true')
      : '';
  });
  ...
  data.antecedentesFamiliares.forEach(antecedenteFam => {
    antecedenteFam == 'Familiar-Cancer'
      ? document.getElementById('checkcancer').setAttribute('checked', 'true')
      : '';
    antecedenteFam == 'Familiar-Tuberculosis'
      ? document
          .getElementById('checktuberculosis')
          .setAttribute('checked', 'true')
      : '';
    antecedenteFam == 'Familiar-HIV'
      ? document.getElementById('checkhiv').setAttribute('checked', 'true')
      : '';
    antecedenteFam == 'Familiar-Diabetes'
      ? document.getElementById('checkdiabetes').setAttribute('checked', 'true')
      : '';
    antecedenteFam == 'Familiar-Cardiovasculares'
      ? document
          .getElementById('checkcardiovasculares')
          .setAttribute('checked', 'true')
      : '';
    antecedenteFam == 'Familiar-Hemorragicas'
      ? document
          .getElementById('checkhemorragicas')
          .setAttribute('checked', 'true')
      : '';
    antecedenteFam == 'Familiar-Venereas'
      ? document.getElementById('checkvenereas').setAttribute('checked', 'true')
      : '';
  });

  document.getElementById('otraenfermedad').value = data.otraenfermedad;

  document.getElementById('motivoprincipalconsulta').value =
    data.motivoprincipalconsulta;

  document.getElementById('fechaultimaconsulta').value =
    data.fechaultimaconsulta;

  document.getElementById('motivoultimaconsulta').value =
    data.motivoultimaconsulta;

  //para 2 radio buttons de si no
  data.checkcomplicaciones == 'true'
    ? document
        .getElementById('checkcomplicaciones1')
        .setAttribute('checked', 'true')
    : '';
  data.checkcomplicaciones == 'false'
    ? document
        .getElementById('checkcomplicaciones2')
        .setAttribute('checked', 'false')
    : '';
  document.getElementById('cualescomplicaciones').value =
    data.cualescomplicaciones;
...
historia.addEventListener('submit', async e => {
  ...
  const genero = document.querySelector('input[name="checkgenero"]:checked')
    ?.value
    ? document.querySelector('input[name="checkgenero"]:checked').value
    : '';

  const edocivil = document.querySelector('input[name="checkedocivil"]:checked')
    ?.value
  ...
  const tratadopormedico = document.querySelector(
    ...
    ? document.querySelector('input[name="checktratadopormedico"]:checked')
        .value
    : '';
  ...
  await db
    ...
    .update(paciente)
    .then(result =>
      alert('La informacion del Paciente ha sido actualizada con exito!')
    )
